    ...
    <template #wrapper>
        <el-card class="box-card">
            ...
            <el-table v-loading="loading" :data="quotationsList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="插电或者太阳能" align="center" prop="powerSource" :show-overflow-tooltip="true" />
            ...
            <el-dialog :title="title" :visible.sync="open" width="500px">
                <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                    ...
                    <el-form-item label="款式" prop="style">
                        <el-select v-model="form.style" placeholder="请选择" @change="handleOptionsChange">
                            <el-option v-for="dict in styleOptions" :key="dict.name" :label="dict.name" :value="dict.name" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="颜色" prop="color">
                        <el-select v-model="form.color" placeholder="请选择" @change="handleOptionsChange">
                    ...
                    <el-form-item label="地区" prop="region">
                        <el-select v-model="form.region" placeholder="请选择" @change="handleOptionsChange">
                            <el-option v-for="dict in regionOptions" :key="dict.name" :label="dict.name" :value="dict.name" />
                        </el-select>
                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        styleFormat(row) {
            console.log("style ", row.style, "styleOptions", this.styleOptions)
