        ...
        <template #wrapper>
            <el-card class="box-card">
                <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
                    <el-form-item label="单号" prop="orderNumber"><el-input v-model="queryParams.orderNumber" placeholder="请输入单号" clearable
                                              size="small" @keyup.enter.native="handleQuery"/>
                            </el-form-item>
                        <el-form-item label="款式" prop="style"><el-select v-model="queryParams.style"
                        ...
                        <el-form-item label="颜色" prop="color"><el-select v-model="queryParams.color"
                                           placeholder="请选择" clearable size="small" >
                                    <el-option
                        ...
                        <el-form-item label="地区" prop="region"><el-select v-model="queryParams.region"
                                           placeholder="请选择" clearable size="small" >
                                    <el-option
                ...
                <el-row :gutter="10" class="mb8">
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['bj:quotations:add']"
                                type="primary"
                                icon="el-icon-plus"
                                size="mini"
                                @click="handleAdd"
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['bj:quotations:edit']"
                                type="success"
                                icon="el-icon-edit"
                                size="mini"
                                :disabled="single"
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['bj:quotations:remove']"
                                type="danger"
                                icon="el-icon-delete"
                                size="mini"
                                :disabled="multiple"
                ...
                <el-table v-loading="loading" :data="quotationsList" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55" align="center"/><el-table-column label="单号" align="center" prop="orderNumber" :show-overflow-tooltip="true"/>
                            <el-table-column label="款式" align="center" prop="style" :formatter="styleFormat" width="100">
                                <template slot-scope="scope">
                                    {{ styleFormat(scope.row) }}
                                </template>
                            </el-table-column>
                            <el-table-column label="颜色" align="center" prop="color" :formatter="colorFormat" width="100">
                                <template slot-scope="scope">
                                    {{ colorFormat(scope.row) }}
                                </template>
                            </el-table-column><el-table-column label="长" align="center" prop="length"
                                                 :show-overflow-tooltip="true"/><el-table-column label="宽" align="center" prop="width"
                                                 :show-overflow-tooltip="true"/><el-table-column label="高" align="center" prop="height"
                                                 :show-overflow-tooltip="true"/><el-table-column label="板厚" align="center" prop="thickness"
                                                 :show-overflow-tooltip="true"/><el-table-column label="管重及额外重量" align="center" prop="pipeWeightAndExtraWeight"
                                                 :show-overflow-tooltip="true"/><el-table-column label="数量" align="center" prop="quantity"
                                                 :show-overflow-tooltip="true"/><el-table-column label="单个白铁重量" align="center" prop="singleIronWeight"
                                                 :show-overflow-tooltip="true"/><el-table-column label="白铁价格" align="center" prop="ironPrice"
                                                 :show-overflow-tooltip="true"/><el-table-column label="烤漆价格" align="center" prop="bakingPaintPrice"
                                                 :show-overflow-tooltip="true"/><el-table-column label="是否需要丝印" align="center" prop="needSilkScreen"
                                                 :formatter="needSilkScreenFormat" width="100">
                                    <template slot-scope="scope">
                                        {{ needSilkScreenFormat(scope.row) }}
                                    </template>
                                </el-table-column><el-table-column label="开模板数" align="center" prop="numberOfOpenTemplates"
                                                 :show-overflow-tooltip="true"/><el-table-column label="开板费" align="center" prop="openBoardFee"
                                                 :show-overflow-tooltip="true"/><el-table-column label="丝印面数" align="center" prop="numberOfSilkScreenFaces"
                                                 :show-overflow-tooltip="true"/><el-table-column label="印几个颜色" align="center" prop="numberOfColors"
                                                 :show-overflow-tooltip="true"/><el-table-column label="印的价格" align="center" prop="printPrice"
                                                 :show-overflow-tooltip="true"/><el-table-column label="运费" align="center" prop="freight"
                                                 :show-overflow-tooltip="true"/><el-table-column label="包装费" align="center" prop="packagingFee"
                                                 :show-overflow-tooltip="true"/><el-table-column label="成本" align="center" prop="cost"
                                                 :show-overflow-tooltip="true"/><el-table-column label="利润" align="center" prop="profit"
                                                 :show-overflow-tooltip="true"/><el-table-column label="最终报价" align="center" prop="finalQuotation"
                                                 :show-overflow-tooltip="true"/><el-table-column label="插电或者太阳能" align="center" prop="powerSource"
                                                 :show-overflow-tooltip="true"/><el-table-column label="灯带费用" align="center" prop="lightStripCost" 
                                                 ...
                                                 <!-- <el-table-column label="发光面数" align="center" prop="numberOfIlluminatedFaces" :formatter="formatNumberOfIlluminatedFaces" width="100">
                                                    <template slot-scope="scope">
                                                        {{ formatNumberOfIlluminatedFaces(scope.row) }}
                                                    </template>
                                                </el-table-column> -->
                                                 <el-table-column label="白板价格" align="center" prop="whiteBoardPrice"
                                                 :show-overflow-tooltip="true"/>
                                                 <el-table-column label="地区" align="center" prop="region" :formatter="regionFormat" width="100">
                                                    <template slot-scope="scope">
                                                        {{ regionFormat(scope.row) }}
                                                    </template>
                                               </el-table-column>
                    ...
                    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                                    ...
                                    <el-form-item label="款式" prop="style">
                                        <el-select v-model="form.style"
                                                       placeholder="请选择" @change="handleOptionsChange" >
                                                <el-option
                                                        v-for="dict in styleOptions"
                                                        :key="dict.name"
                                                        :label="dict.name"
                                    ...
                                    <el-form-item label="板厚" prop="thickness">
                                        <el-input v-model="form.thickness" placeholder="板厚"
                                                      />
                                    </el-form-item>
                                    ...
                                    <el-form-item label="是否需要丝印" prop="needSilkScreen">
                                        <el-radio-group v-model="form.needSilkScreen">
                                                <el-radio
                                                        v-for="dict in needSilkScreenOptions"
                                                        :key="dict.value"
                                                        :label="dict.value"
                                                >{{ dict.label }}</el-radio>
                                            </el-radio-group>
                                    ...
                                    <el-form-item label="插电或者太阳能" prop="powerSource">
                                        <el-input v-model="form.powerSource" placeholder="插电或者太阳能"
                                                      />
                                    </el-form-item>
                                    <el-form-item label="灯带费用" prop="lightStripCost">
                                        <el-input v-model="form.lightStripCost" placeholder="灯带费用"
                                                      />
                                    </el-form-item>
                                    <el-form-item label="发光面" prop="numberOfIlluminatedFaces">
                                        <el-select v-model="form.numberOfIlluminatedFaces" placeholder="请选择发光面">
                                            <el-option label="不发光" :value="0"></el-option>
...
<script>
    import {addQuotationsV1, delQuotationsV1, getQuotationsV1, listQuotationsV1, updateQuotationsV1} from '@/api/bj/quotations-v1'
// import { XLSX } from 'xlsx'
    import {listStyles } from '@/api/bj/styles'
    import {listPaints } from '@/api/bj/paints'
    import {listRegions } from '@/api/bj/regions'
import { transactionList } from '@/api/remote-search'
    export default {
        ...
        data() {
            return {
                ...
                // 表单校验
                rules: {orderNumber:  [ {required: true, message: '单号不能为空', trigger: 'blur'}],
                        extraAttributes: [{ validator: this.validateJson, trigger: 'change' }],
                style:  [ {required: true, message: '款式不能为空', trigger: 'blur'} ],
    ...
    // },
        handleOptionsChange(value) {
                //console.log('handleRegionChange triggered with value:', value)
                //console.log('regionOptions:', this.regionOptions)
                const options = [this.styleOptions, this.colorOptions, this.regionOptions]
                let selectedOption

                for (let i = 0; i < options.length; i++) {
                    selectedOption = options[i].find(option => option.name === value)
                    if (selectedOption) {
                        break
                    }
                }
                ...
                if (selectedOption) {
                    for (let key in selectedOption) {
                        if (selectedOption.hasOwnProperty(key) && key !== 'name' && key !== 'id') {
            ...
            formatNumberOfIlluminatedFaces(row) {
                switch (row.numberOfIlluminatedFaces) {
                    ...
                    return '双面';
                    default:
                    return cellValue; // 如果值不是预期的数字，返回原始值
                }
            },
            // 关系
            getStylesItems() {
               this.getItems(listStyles, undefined).then(res => {
                   this.styleOptions = this.setItemsNew(res, ["name", "price"],["name", "style_price"])
               })
            },
            getPaintsItems() {
            ...
            getRegionsItems() {
                this.getItems(listRegions, undefined).then(res => {
                    ...
                    this.regionOptions = this.setItemsNew(res, ["name", "base1", "base2"],["name", "base1", "base2"])
               })
            },
            // 文件
            /** 搜索按钮操作 */
            ...
            handleDelete(row) {
                ...
                this.$confirm('是否确认删除编号为"' + Ids + '"的数据项?', '警告', {
                    ...
                    type: 'warning'
                      ...
                      return delQuotationsV1( { 'ids': Ids })
                }).then((response) => {
                   if (response.code === 200) {
                     this.msgSuccess(response.msg)
                     this.open = false
